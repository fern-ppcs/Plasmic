...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: 2XDp2h28vQb-/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 37yrt0gPWgI4/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: r7OD2TQKB7DX/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__gFFvl)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__uifNh)}
                role={"img"}
              />
            ),
